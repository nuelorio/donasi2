...
<?php
    ...
    if(isset($_POST['lanjutkan'])){
    	...
    	if(!empty($errors)){
    		...
    		$sql_donasi = "UPDATE donasi SET nominal = '$nominal', kode_donasi = '$kode_donasi' WHERE email = '$email'";

    		$sql_lembaga = "UPDATE lembaga SET 
    		paud = '$paud', 
    		tk = '$tk', 
    		sd = '$sd', 
    		smp = '$smp', 
    		...
    		$sql_peruntukan = "UPDATE peruntukan SET 
    		pendidikan = '$fp',
    		umum = '$fu',
    		lain = '$lain4'
    		WHERE email = '$email'";
    		...
    		header('Location:langkah3.php?email='.$email);
    	}
    }
?>
